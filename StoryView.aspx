...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="storyFormat">
        ...
        <asp:TextBox ID="StoryTitleEntry" runat="server" Width="432px" AutoPostBack="True" ReadOnly="True"></asp:TextBox>
        ...
        <asp:TextBox ID="StoryDateEntry" runat="server" Width="357px" AutoPostBack="True" ReadOnly="True" TextMode="SingleLine"></asp:TextBox>
        <br />
        ...
        <asp:TextBox ID="StorySourceEntry" runat="server" Width="415px" AutoPostBack="True" ReadOnly="True"></asp:TextBox>
        <br />
