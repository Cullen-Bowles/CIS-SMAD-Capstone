    ...
    public partial class SubmitRequest : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!Page.IsPostBack)
            {
                ...
                con2.Close();
                con.Open();
                var sqlQuery = "SELECT TextID, StoryTitle FROM Story WHERE UserID = @UserID";
                ...
                con.Close();
                ddlusersstories.Items.Insert(0,
                    new ListItem("Select a Story", "0")); //placeholder for when page is first loaded
        ...
        protected void ddlusersstories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var comm = new SqlCommand(
                "SELECT TextID, StoryTitle, StorySource, StoryText FROM Story WHERE TextID=" +
                ddlusersstories.SelectedValue, con);
            var srd = comm.ExecuteReader();
            if (srd.Read())
            {
