...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row mb-1">
        <div class="col-6">
            <asp:DropDownList ID="ddlusersstories" CssClass="form-control" runat="server" OnSelectedIndexChanged="ddlusersstories_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
        </div>
    </div>
    <%--<div class="row mb-1">
        <div class="col-3">
    ...
    <div class="row mb-1">
        ...
        <div class="col-8"><asp:TextBox ID="txtURL" CssClass="form-control" runat="server" Width="300"></asp:TextBox></div>
    </div>
    <div class="row mb-1">
        <div class="col-4"><asp:Label ID="lblStoryBody" runat="server" Text="Body of Story Text:"></asp:Label></div>
        <div class="col-8"><asp:TextBox ID="txtStory" CssClass="form-control" runat="server" TextMode="MultiLine" Width="600" Height="200"></asp:TextBox></div>
    </div>
    <div class="row mb-1">
            <div class="col-4"><asp:Button ID="btnSubmit" CssClass="btn btn-success" runat="server" Text="Send Story to SA for Analysis ->" OnClick="btnSubmit_Click" /></div>
